...
const AGROS_LAYERS: Omit<LayerManifest, 'status'>[] = [
  ...
  },
  {
    ...
    components: [
      ...
      { name: 'ReplayHistoryVerifier', path: 'backend:diagnostics/replayHistory.ts', type: 'service', status: 'stable', dependencies: ['ReinforcementReplayVerifier'] },
      { name: 'ReplayCheckpointDiff', path: 'backend:diagnostics/replayHistory.ts', type: 'service', status: 'stable', dependencies: ['ReplayHistoryVerifier'] },
      { name: 'ReplayHistoryMonitor', path: 'backend:diagnostics/replayHistory.ts', type: 'service', status: 'stable', dependencies: ['ReplayHistoryVerifier', 'ReplayCheckpointDiff'] },
      { name: 'ReplayMonitorSnapshots', path: 'backend:storage/repository.ts', type: 'service', status: 'stable', dependencies: ['ReplayHistoryMonitor'] },
      { name: 'DegradedReplayExport', path: 'backend:diagnostics/continuityExport.ts', type: 'service', status: 'stable', dependencies: ['ReplayHistoryMonitor', 'ContinuityExport'] },
      { name: 'ReleaseReadinessGate', path: 'backend:diagnostics/releaseReadiness.ts', type: 'service', status: 'stable', dependencies: ['ReplayHistoryMonitor', 'ReplayMonitorSnapshots'] },
      { name: 'ReleaseEvidenceArchive', path: 'backend:diagnostics/releaseReadiness.ts', type: 'service', status: 'stable', dependencies: ['ReleaseReadinessGate', 'DegradedReplayExport'] },
      { name: 'ReleaseDecisionArchive', path: 'backend:diagnostics/releaseReadiness.ts', type: 'service', status: 'stable', dependencies: ['ReleaseEvidenceArchive'] },
      { name: 'ReleaseEvidenceComparator', path: 'backend:diagnostics/releaseReadiness.ts', type: 'service', status: 'stable', dependencies: ['ReleaseEvidenceArchive'] },
      { name: 'ReleaseReconciliationArchive', path: 'backend:diagnostics/releaseReadiness.ts', type: 'service', status: 'stable', dependencies: ['ReleaseDecisionArchive'] },
      { name: 'ReleaseBundleSummary', path: 'backend:diagnostics/releaseReadiness.ts', type: 'service', status: 'stable', dependencies: ['ReleaseDecisionArchive', 'ReleaseReconciliationArchive', 'ReleaseEvidenceComparator'] },
      { name: 'ReleaseEvidenceRetention', path: 'backend:diagnostics/releaseReadiness.ts', type: 'service', status: 'stable', dependencies: ['ReleaseEvidenceArchive'] },
      { name: 'PostReleaseDriftMonitor', path: 'backend:diagnostics/releaseReadiness.ts', type: 'service', status: 'stable', dependencies: ['ReleaseDecisionArchive', 'ReleaseReadinessGate'] },
      { name: 'ReleaseSupervisionCard', path: 'backend:diagnostics/releaseReadiness.ts', type: 'service', status: 'stable', dependencies: ['ReleaseBundleSummary', 'PostReleaseDriftMonitor', 'ReleaseEvidenceRetention'] },
      { name: 'ReleaseDriftOverrideArchive', path: 'backend:diagnostics/releaseReadiness.ts', type: 'service', status: 'stable', dependencies: ['PostReleaseDriftMonitor'] },
      { name: 'ReleaseDeploymentCommandDescriptors', path: 'backend:diagnostics/releaseReadiness.ts', type: 'service', status: 'stable', dependencies: ['ReleaseSupervisionCard'] },
      { name: 'ReleasePromotionRunArchive', path: 'backend:diagnostics/releaseReadiness.ts', type: 'service', status: 'stable', dependencies: ['ReleaseSupervisionCard', 'ReleaseDeploymentCommandDescriptors'] },
      { name: 'ReleasePromotionTimelineExport', path: 'backend:diagnostics/releaseReadiness.ts', type: 'service', status: 'stable', dependencies: ['ReleasePromotionRunArchive'] },
      { name: 'ReleaseRollbackCommandDescriptors', path: 'backend:diagnostics/releaseReadiness.ts', type: 'service', status: 'stable', dependencies: ['ReleasePromotionTimelineExport'] },
      { name: 'ReleaseRollbackRunArchive', path: 'backend:diagnostics/releaseReadiness.ts', type: 'service', status: 'stable', dependencies: ['ReleasePromotionTimelineExport', 'ReleaseRollbackCommandDescriptors'] },
      { name: 'ReleaseRollbackTimelineExport', path: 'backend:diagnostics/releaseReadiness.ts', type: 'service', status: 'stable', dependencies: ['ReleaseRollbackRunArchive'] },
      { name: 'ReleaseEvidenceBundleManifest', path: 'backend:diagnostics/releaseReadiness.ts', type: 'service', status: 'stable', dependencies: ['ReleaseBundleSummary', 'ReleasePromotionTimelineExport', 'ReleaseRollbackTimelineExport'] },
      { name: 'ReleaseArtifactVerification', path: 'backend:diagnostics/releaseReadiness.ts', type: 'service', status: 'stable', dependencies: ['ReleaseEvidenceBundleManifest'] },
      { name: 'ReleaseIncidentPacketExport', path: 'backend:diagnostics/releaseReadiness.ts', type: 'service', status: 'stable', dependencies: ['ReleaseEvidenceBundleManifest', 'ReleaseArtifactVerification', 'PostReleaseDriftMonitor', 'ReleaseRollbackTimelineExport'] },
      { name: 'ContinuityExport', path: 'backend:diagnostics/continuityExport.ts', type: 'service', status: 'stable', dependencies: ['ReplayHistoryVerifier'] },
      ...
      { name: 'ReplayOperationsPanel', path: 'components/ReplayOperationsPanel.tsx', type: 'ui', status: 'stable', dependencies: ['ReplayHistoryVerifier', 'ReplayCheckpointDiff', 'ReplayHistoryMonitor', 'ReplayMonitorSnapshots', 'DegradedReplayExport', 'ContinuityExport'] },
      { name: 'ReleaseReadinessPanel', path: 'components/ReleaseReadinessPanel.tsx', type: 'ui', status: 'stable', dependencies: ['ReleaseReadinessGate', 'ReleaseEvidenceArchive', 'ReleaseDecisionArchive', 'ReleaseEvidenceComparator', 'ReleaseReconciliationArchive', 'ReleaseBundleSummary', 'ReleaseEvidenceRetention', 'PostReleaseDriftMonitor', 'ReleaseSupervisionCard', 'ReleaseDriftOverrideArchive', 'ReleaseDeploymentCommandDescriptors', 'ReleasePromotionRunArchive', 'ReleasePromotionTimelineExport', 'ReleaseRollbackCommandDescriptors', 'ReleaseRollbackRunArchive', 'ReleaseRollbackTimelineExport', 'ReleaseEvidenceBundleManifest', 'ReleaseArtifactVerification', 'ReleaseIncidentPacketExport'] },
    ],
  ...
  },
  {
    ...
    order: 9,
    components: [
      { name: 'IntegrityLoop', path: 'struthio/integrity.ts', type: 'core', status: 'stable', dependencies: [] },
      { name: 'DriftDetector', path: 'struthio/drift.ts', type: 'service', status: 'stable', dependencies: ['IntegrityLoop'] },
      { name: 'RecoveryEngine', path: 'struthio/recovery.ts', type: 'service', status: 'stable', dependencies: ['IntegrityLoop', 'IndexedDBPersistence'] },
      { name: 'ConsensusValidator', path: 'struthio/consensus.ts', type: 'service', status: 'stable', dependencies: ['IntegrityLoop'] },
    ],
