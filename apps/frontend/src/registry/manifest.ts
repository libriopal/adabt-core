...
const AGROS_LAYERS: Omit<LayerManifest, 'status'>[] = [
  ...
  },
  {
    ...
    components: [
      ...
      { name: 'ReplayOperationsPanel', path: 'components/ReplayOperationsPanel.tsx', type: 'ui', status: 'stable', dependencies: ['ReplayHistoryVerifier', 'ReplayCheckpointDiff', 'ReplayHistoryMonitor', 'ContinuityExport'] },
    ],
