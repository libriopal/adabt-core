...
const AGROS_LAYERS: Omit<LayerManifest, 'status'>[] = [
  ...
  },
  {
    ...
    components: [
      ...
      { name: 'ReleaseReadinessPanel', path: 'components/ReleaseReadinessPanel.tsx', type: 'ui', status: 'stable', dependencies: ['ReleaseReadinessGate', 'ReleaseEvidenceArchive', 'ReleaseDecisionArchive', 'ReleaseEvidenceComparator'] },
    ],
